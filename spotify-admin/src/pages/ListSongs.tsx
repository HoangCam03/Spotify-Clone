...
const ListSongs: FC = () => {
  ...
  return (
    <div className="p-6 bg-gray-900 text-white rounded">
      <h1 className="text-2xl mb-4">Danh Sách Bài Hát</h1>
      <table className="w-full">
        <thead>
          <tr className="border-b border-gray-700">
            <th className="text-left p-2">Tên</th>
            <th className="text-left p-2">Nghệ sĩ</th>
            <th className="text-left p-2">Hành động</th>
          </tr>
        </thead>
        <tbody>
          {songs.map((song) => (
            <tr key={song._id} className="border-b border-gray-800 hover:bg-gray-800">
